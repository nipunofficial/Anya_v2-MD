...
module.exports = {
     ...
     */
    botname: process.env.BotName || "𝐊𝐢𝐧𝐠 𝐍𝐈𝐏𝐔 ᴠ5",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝐊𝐢𝐧𝐠 𝐍𝐃 𝐁𝐨𝐭",
     ...
     */
    ownername: process.env.Owner_Name || "𝐍𝐢𝐩𝐮-𝐌𝐃",
    ownernumber: process.env.Owner_Number || "94727255904",
    instagramId: process.env.Insta || "3.69_pika",

    /**
     * other details and parameters
     */
    author: process.env.Author || "𝐍𝐃-𝐁𝐨𝐭𝐳 🌚🌙",
    packname: process.env.PackName || "𝖐𝖎𝖓𝖌 𝕹𝖎𝖕𝖚𝖓 𝖁5 𝕾𝖙𝖎𝖈𝖐𝖊𝖗 𝕻𝖆𝖈𝖐 🪀",
    ...
    sessionId: process.env.SESSION_ID || "vBfirKBUtF0b6O_A_N_Y_A_V_2_bxIxMV",
